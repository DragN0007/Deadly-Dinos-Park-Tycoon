...
public class Australo extends TamableAnimal implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public Australo(EntityType<? extends Australo> entityType, Level level) {
    ...
    public static final Predicate<LivingEntity> PREY_SELECTOR = (entity) -> {
        ...
        if (entity.getType() == EntityTypes.AUSTRALO_ENTITY.get()) {
            return false;
        }
        return true;
    };
    ...
    public boolean canMate(Animal animal) {
        if (animal == this || !(animal instanceof Australo)) {
            return false;
        } else {
            return this.canBeParent() && ((Australo)animal).canBeParent();
        }
    }
    @Override
    public Australo getBreedOffspring(ServerLevel level, AgeableMob ageableMob) {
        return EntityTypes.AUSTRALO_ENTITY.get().create(level);
    }
