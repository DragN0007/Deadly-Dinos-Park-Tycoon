...
public class YutyScreen extends AbstractContainerScreen<YutyMenu> {
    ...
    private static final ResourceLocation SADDLED = new ResourceLocation(DeadlyDinosPT.MODID, "textures/gui/yuty_empty_gui.png");
    private static final ResourceLocation CHESTED = new ResourceLocation(DeadlyDinosPT.MODID, "textures/gui/yuty_gui.png");
