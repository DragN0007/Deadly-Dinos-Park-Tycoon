...
public class Cryo extends TamableAnimal implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public Cryo(EntityType<? extends Cryo> entityType, Level level) {
    ...
    public static final Predicate<LivingEntity> PREY_SELECTOR = (entity) -> {
        ...
        if (entity.getType() == EntityTypes.CRYO_ENTITY.get()) {
            return false;
        }
        return true;
    };
    ...
    public boolean canMate(Animal animal) {
        if (animal == this || !(animal instanceof Cryo)) {
            return false;
        } else {
            return this.canBeParent() && ((Cryo)animal).canBeParent();
        }
    }
    @Override
    public Cryo getBreedOffspring(ServerLevel level, AgeableMob ageableMob) {
        return EntityTypes.CRYO_ENTITY.get().create(level);
    }
