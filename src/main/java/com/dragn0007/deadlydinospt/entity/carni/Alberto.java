...
public class Alberto extends TamableAnimal implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public Alberto(EntityType<? extends Alberto> entityType, Level level) {
    ...
    public boolean canMate(Animal animal) {
        if (animal == this || !(animal instanceof Alberto)) {
            ...
            return this.canBeParent() && ((Alberto)animal).canBeParent();
        }
    }
    @Override
    public Alberto getBreedOffspring(ServerLevel level, AgeableMob ageableMob) {
        return EntityTypes.ALBERTO_ENTITY.get().create(level);
    }
