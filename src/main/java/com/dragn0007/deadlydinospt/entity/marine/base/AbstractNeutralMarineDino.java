...
public abstract class AbstractNeutralMarineDino extends WaterDino {
    ...
    public abstract AbstractNeutralMarineDino getBreedOffspring(ServerLevel level, AgeableMob ageableMob);
