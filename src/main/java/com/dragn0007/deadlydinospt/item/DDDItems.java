...
public class DDDItems {
    ...
    public static final RegistryObject<Item> ANDAL_EGG = ITEMS.register("andal_egg",
            () -> new ForgeSpawnEggItem(EntityTypes.ANDAL_ENTITY, 0x00FFFFFF, 0x00FFFFFF, new Item.Properties().stacksTo(1).tab(DDDItemGroup.DINO_GROUP)));
    public static final RegistryObject<Item> CARCHAR_EGG = ITEMS.register("carchar_egg",
            () -> new ForgeSpawnEggItem(EntityTypes.CARCHAR_ENTITY, 0x00FFFFFF, 0x00FFFFFF, new Item.Properties().stacksTo(1).tab(DDDItemGroup.DINO_GROUP)));
    public static final RegistryObject<Item> ALLO_EGG = ITEMS.register("allo_egg",
            () -> new ForgeSpawnEggItem(EntityTypes.ALLO_ENTITY, 0x00FFFFFF, 0x00FFFFFF, new Item.Properties().stacksTo(1).tab(DDDItemGroup.DINO_GROUP)));
    public static final RegistryObject<Item> DILO_EGG = ITEMS.register("dilo_egg",
            () -> new ForgeSpawnEggItem(EntityTypes.DILO_ENTITY, 0x00FFFFFF, 0x00FFFFFF, new Item.Properties().stacksTo(1).tab(DDDItemGroup.DINO_GROUP)));


    //HERBIVORE EGGS
    public static final RegistryObject<Item> CROPSNAIL_EGG = ITEMS.register("cropsnail_egg",
            () -> new ForgeSpawnEggItem(EntityTypes.CROPSNAIL_ENTITY, 0x9648273, 0xbd864b, new Item.Properties().stacksTo(1).tab(DDDItemGroup.DINO_GROUP)));
    ...
    public static final RegistryObject<Item> GRYPO_EGG = ITEMS.register("grypo_egg",
            () -> new ForgeSpawnEggItem(EntityTypes.GRYPO_ENTITY, 0x00FFFFFF, 0x00FFFFFF, new Item.Properties().stacksTo(1).tab(DDDItemGroup.DINO_GROUP)));
    public static final RegistryObject<Item> AMPELO_EGG = ITEMS.register("ampelo_egg",
            () -> new ForgeSpawnEggItem(EntityTypes.AMPELO_ENTITY, 0x00FFFFFF, 0x00FFFFFF, new Item.Properties().stacksTo(1).tab(DDDItemGroup.DINO_GROUP)));
