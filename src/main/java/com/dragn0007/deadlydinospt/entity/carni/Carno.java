...
public class Carno extends TamableAnimal implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public Carno(EntityType<? extends Carno> entityType, Level level) {
    ...
    public static final Predicate<LivingEntity> PREY_SELECTOR = (entity) -> {
        ...
        if (entity.getType() == EntityTypes.CARNO_ENTITY.get()) {
            return false;
        }
        return true;
    };
    ...
    public boolean canMate(Animal animal) {
        if (animal == this || !(animal instanceof Carno)) {
            return false;
        } else {
            return this.canBeParent() && ((Carno)animal).canBeParent();
        }
    }
    @Override
    public Carno getBreedOffspring(ServerLevel level, AgeableMob ageableMob) {
        return EntityTypes.CARNO_ENTITY.get().create(level);
    }
